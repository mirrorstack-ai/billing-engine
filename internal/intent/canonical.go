...
// same digest.
// v4 adds the sealed rail and routing-policy revision. v3 added the
// funding split (wallet allocation and provider remainder); v2 added the
// tax determination's verification class. The tag moves with
...
// trigger.
const canonicalSchema = "mirrorstack.charge-intent/v4"
