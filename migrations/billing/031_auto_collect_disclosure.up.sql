-- Migration 031 — large auto-collected charge DISCLOSURE (transparency flag).
--
...
--
-- Born clean at slot 031 (next free after 028; 029/030 reserved by sibling
-- worktrees in flight). sqlc picks up both columns from migrations/billing/
-- automatically. updated_at on both tables is trigger-maintained (001).
--
